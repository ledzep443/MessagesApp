...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220710225155_AddIssueStatusToIssuesModel")]
    partial class AddIssueStatusToIssuesModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DataAccess.ChatMessage", b =>
                {
                    b.HasOne("DataAccess.ApplicationUser", "FromUser")
                        .WithMany("ChatMessagesFromUsers")
                        .HasForeignKey("FromUserId")
                        .IsRequired();

                    b.HasOne("DataAccess.ApplicationUser", "ToUser")
